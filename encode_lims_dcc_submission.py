...
def read_truptis_file(truptis_file):
    value_list = open(truptis_file, "rU")
    record_values = csv.DictReader(value_list,delimiter = '\t')
    dict_output = open("truptis_output_file.json", "w")
    ...
    for record in record_values:
        ...
        experiments_dict = {}
        experiment_alias = 'michael-snyder:' + str(record.get('Cell_line')) + '-' + str(record.get('Targets'))
        if experiment_alias  not in experiment_check.keys():
            ...
            experiments_dict['biosample_type'] = "immortalized cell line"
        ...
        #library_dict['size_range'] = 'Unknown' - Where to get this information
        ...
        #replicates_dict['read_length'] = 101 - Where to get this information
...
if __name__ == "__main__":
    ...
    parser.add_argument('truptis_file', help='A tab delimited file that needs processing.')
    ...
    read_truptis_file(args.truptis_file)
